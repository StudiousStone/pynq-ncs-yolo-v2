...
CPP = g++
PYTHON_VERSION = 3.6m
PYTHON_INCLUDE = /opt/python3.6/include/python$(PYTHON_VERSION)
...
LIBRARIES = -L/usr/lib -L/opt/python3.6/lib -L/usr/lib/arm-linux-gnueabihf/ -lpython$(PYTHON_VERSION) -lboost_python-py35
